...
public class AdminCategoryActivity extends AppCompatActivity {
    private ImageView v_fruits, groceries;
    private ImageView households;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v_fruits = (ImageView) findViewById(R.id.v_fruits);
        ...
        households.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(AdminCategoryActivity.this, com.app.shopping.AdminAddNewProductActivity.class);
                intent.putExtra("category", "house_holds");
                startActivity(intent);
            }
        });
